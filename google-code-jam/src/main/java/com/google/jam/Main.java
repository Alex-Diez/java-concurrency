...
public class Main {
	...
	public static void main(String[] args)
		...
		Map<Integer, Integer> smallResult = resolver.solve(smallRound, new InputInfiniteHouseOfPancakesContestAnalysisAlgorithm());
		...
		Map<Integer, Integer> largeResult = resolver.solve(largeRound, new InputInfiniteHouseOfPancakesContestAnalysisAlgorithm());
