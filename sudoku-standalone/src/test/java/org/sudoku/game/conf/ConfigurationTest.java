...
public class ConfigurationTest {
    ...
    @Test
    public void testNumbersOfSquares()
            throws Exception {
    ...
    @Test
    public void testNumbersOfElements()
            throws Exception {
        assertThat(configuration.getNumberOfElements(), is(numberOfElements));
    }

    @Test
    public void testNumberOfElementsOnSide()
            throws Exception {
    ...
    @Test
    public void testNumberOfElementsOnSquareSide()
            throws Exception {
    ...
    @Test
    public void testNumberOfSquaresOnSide()
            throws Exception {
