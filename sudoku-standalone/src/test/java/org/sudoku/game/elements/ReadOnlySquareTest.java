...
public class ReadOnlySquareTest {
    ...
    @Test
    public void testReadElementFrom()
            throws Exception {
    ...
    @Test
    public void testPrintableFirstLine()
            throws Exception {
